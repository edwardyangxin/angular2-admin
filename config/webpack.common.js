...
module.exports = {
  ...
  module: {
    ...
    loaders: [
      ...
      */
      ...
      /**
       * Scss loader for supporting Sass and SCSS files.
       */
      {
        test: /\.(sass|scss)$/,
      ...
      /**
       * Font loader for supporting font files.
       */
      {
  ...
  plugins: [
    ...
    /**
     * This plugin makes '$' and 'jQuery' available in every module without writing require("jquery").
     * 
